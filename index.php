...
<head>
    ...
    <title>TWO BROTHERS SOFTWARES - Payment Checkout</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="checkout-container">
        <div class="brand">TWO BROTHERS SOFTWARES</div>
        <form id="paymentForm">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" required value="nyootitom@gmail.com">
            </div>
            <div class="mb-3">
    ...
    <script type="text/javascript">
        ...
        function payWithPaystack(e) {
            ...
            let handler = PaystackPop.setup({
                ...
                onClose: function() {
                    window.location.href = "http://localhost:8000/failure.php";
                },
                callback: function(response) {
                    window.location.href = "http://localhost:8000/verify_transaction.php?reference=" + response.reference;
                }
            });
            handler.openIframe();
        }
